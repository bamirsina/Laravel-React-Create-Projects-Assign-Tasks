  ...
  return (
    ...
    >
      ...
      <div className="py-12">
        ...
        {/*      </h3>*/}
        {/*      <p className="text-xl mt-4">*/}
        {/*        <span className="mr-2">{myPendingProjects}</span>/*/}
        {/*        <span className="ml-2">{totalPendingProjects}</span>*/}
        {/*      </p>*/}
        {/*    </div>*/}
        {/*  </div>*/}
        {/*  <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">*/}
        ...
        {/*      </h3>*/}
        {/*      <p className="text-xl mt-4">*/}
        {/*        <span className="mr-2">{myProgressProjects}</span>/*/}
        {/*        <span className="ml-2">{totalProgressProjects}</span>*/}
        {/*      </p>*/}
        {/*    </div>*/}
        {/*  </div>*/}
        {/*  <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">*/}
        ...
        {/*      </h3>*/}
        {/*      <p className="text-xl mt-4">*/}
        {/*        <span className="mr-2">{myCompletedProjects}</span>/*/}
        {/*        <span className="ml-2">{totalCompletedProjects}</span>*/}
        {/*      </p>*/}
        {/*    </div>*/}
        {/*  </div>*/}
        {/*</div>*/}
